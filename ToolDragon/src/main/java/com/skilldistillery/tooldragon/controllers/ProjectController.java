...
public class ProjectController {
	...
	private Project create(HttpServletRequest req, HttpServletResponse res, Principal principal, @RequestBody Project project) {
		try {
	...
	private Project update(HttpServletRequest req, HttpServletResponse res, Principal principal, @RequestBody Project project, @PathVariable int id) {
